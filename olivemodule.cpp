...
/*
 * There are three scenarios, in which OliveModule can be loaded by NEST:
 *
...
nest_tc::OliveModule mymodule_LTX_mod;
#endif
// -- DynModule functions ------------------------------------------------------

nest_tc::OliveModule::OliveModule()
{
#ifdef LINKED_MODULE
...
const std::string
nest_tc::OliveModule::name( void ) const
{
  return std::string( "Olive NEST Module" ); // Return name of the module
}

const std::string
nest_tc::OliveModule::commandstring( void ) const
{
  // Instruct the interpreter to load olivemodule-init.sli
  return std::string( "" );
  // return std::string( "(olivemodule-init) run" );
}

//-------------------------------------------------------------------------------------

void
nest_tc::OliveModule::init( SLIInterpreter* i )
{
  /* Register a neuron or device model.
     Give node type as template argument and the name as second argument.
  */
  nest::kernel().model_manager.register_node_model< nest_tc::hh_sdl_alpha_gap >(
    "hh_sdl_alpha_gap" );
