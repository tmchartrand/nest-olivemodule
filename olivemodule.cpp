...
nest::OliveModule mymodule_LTX_mod;
#endif
// -- DynModule functions ------------------------------------------------------

nest::OliveModule::OliveModule()
{
#ifdef LINKED_MODULE
...
const std::string
nest::OliveModule::name( void ) const
{
  return std::string( "Olive NEST Module" ); // Return name of the module
}

const std::string
nest::OliveModule::commandstring( void ) const
{
...
void
nest::OliveModule::init( SLIInterpreter* i )
{
  /* Register a neuron or device model.
     Give node type as template argument and the name as second argument.
  */
  nest::kernel().model_manager.register_node_model< nest::hh_sdl_alpha_gap >(
    "hh_sdl_alpha_gap" );
