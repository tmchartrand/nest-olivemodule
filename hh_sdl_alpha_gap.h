...
class hh_sdl_alpha_gap : public nest::Archiving_Node
{
...
public:
  ...
  nest::port send_test_event(
    nest::Node& target, nest::rport receptor_type,
     nest::synindex, bool );
  ...
  void sends_secondary_event( nest::GapJunctionEvent& )
  {
  }
...
private:
  ...
  friend class nest::RecordablesMap< hh_sdl_alpha_gap >;
  friend class nest::UniversalDataLogger< hh_sdl_alpha_gap >;
...
private:
  ...
  struct Buffers_
  {
    ...
    nest::UniversalDataLogger< hh_sdl_alpha_gap > logger_;
  ...
  static nest::RecordablesMap< hh_sdl_alpha_gap > recordablesMap_;
};

inline void
hh_sdl_alpha_gap::update( nest::Time const& origin, const long from, const long to )
{
  update_( origin, from, to, false );
}

inline bool
hh_sdl_alpha_gap::wfr_update( nest::Time const& origin,
  const long from,
  const long to )
{
  bool done = false;
...
inline nest::port
hh_sdl_alpha_gap::send_test_event( nest::Node& target,
...
inline nest::port
hh_sdl_alpha_gap::handles_test_event( nest::SpikeEvent&,
  nest::rport receptor_type )
{
  if ( receptor_type != 0 )
  {
...
inline nest::port
hh_sdl_alpha_gap::handles_test_event( nest::CurrentEvent&,
  nest::rport receptor_type )
{
  if ( receptor_type != 0 )
  {
...
inline nest::port
hh_sdl_alpha_gap::handles_test_event( nest::DataLoggingRequest& dlr,
  nest::rport receptor_type )
{
  if ( receptor_type != 0 )
  {
...
inline nest::port
hh_sdl_alpha_gap::handles_test_event( nest::GapJunctionEvent&,
  nest::rport receptor_type )
{
  if ( receptor_type != 0 )
  {
